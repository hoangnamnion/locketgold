...
HEADERS = {
    ...
    'Accept': '*/*',
    'X-Platform': 'iOS',
    'X-Platform-Version': 'Version 26.3 (Build 23D127)',
    ...
    'X-Storefront': 'VNM',
    'X-Apple-Device-Identifier': 'B9B7AD38-E55A-4D22-A4B8-94F1E24CF251',
    'X-Preferred-Locales': 'vi_KR,ko_KR,en_KR',
    'X-Nonce': 'Tmj1wNQ585BuItXh',
    'X-Is-Backgrounded': 'false',
    'X-Retry-Count': '0',
    'X-Is-Debug-Build': 'false',
    'User-Agent': 'Locket/591 CFNetwork/3860.400.51 Darwin/25.3.0',
    'Accept-Language': 'vi-VN,vi;q=0.9',
    'Connection': 'keep-alive',
    'Pragma': 'no-cache',
    'Cache-Control': 'no-cache',
    'X-RevenueCat-ETag': '50b0d549077fb523'
}
